            ...
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
                ...
                <md-card>
                    ...
                    <md-card-content>
                        ...
                        <div>
                            <b-table id="my-table" striped hover :items="dsNhacNo" :fields="headers" :per-page="perPage"
                                ...
                                <template v-slot:cell(actions)="row">
                                    <div class="md-table-cell-container">
                                        ...
                                        <button v-if="selected == 1" type="button" title="Thanh toán"
                                            @click="xemThanhToanNo(row, true)"
                            ...
                            <div class="paging-right md-card-actions md-alignment-space-between">
                                <div></div>
                                <b-pagination class="pagination-success " v-model="currentPage" :total-rows="totalRows"
                                    :per-page="perPage" @input="getNhacNo" aria-controls="my-table"></b-pagination>
                            </div>
